...
#define GDT_CODE_0_SEL (GDT_IDX_CODE_0 << 3) | 0 // OR 0 porque setea los ultimos 3 bits en 100 (Global table y privilegio 0)
#define GDT_DATA_0_SEL (GDT_IDX_DATA_0 << 3) | 0
#define GDT_CODE_3_SEL (GDT_IDX_CODE_3 << 3) | 3 //OR 3 porque setea los ultimos 3 bits en 111 (Global table y privilegio 3)
...
#define INTG_TYPE_16 6
#define INTG_TYPE_32 14


#define CLOCK_INT 0x20 //32
#define KEYBBOARD_INT 0x21 // 33
#define SYSCALL1_INT 0x62 //98
#define SYSCALL_INT 0x58 // 88
